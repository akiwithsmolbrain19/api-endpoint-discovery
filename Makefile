...
.PHONY: server crawl discover test
...
discover:
	$(PY) -c "from crawler import crawl; from endpoint_discovery import discover_endpoints; import json; print(json.dumps(discover_endpoints(crawl('$(URL)')), indent=2))"
